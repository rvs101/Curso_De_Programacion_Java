...
public class T5ReglasMensajesJuego {
	...
	public static void setJugadorGanador(String msn) {
		...
		System.out.println("✳ El Jugador " + T5JugadorPersona.getJugadorNombre() + " con el arma " + getArmaJugador()
				+ " ha ganado a la " + T5JugadorMaquina.getMaquinaNombre() + " con el arma " + getArmaMaquina());
		System.out.println("________________________________________");
	}
