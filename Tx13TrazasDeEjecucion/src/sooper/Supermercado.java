...
// • Utilizar la clase Logger para generar trazas de depuración
		Logger logger = Logger.getLogger("huerto.macetas.Maceta");
// • Crear las trazas 'traces' para cadenas de texto
