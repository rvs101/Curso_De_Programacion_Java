...
/**
 * Introduce las siglas para el idioma al que quieres traducir el texto original
 * 
 * @author RVS
 * 
 ...
 *
 */
public class Tx14MessageFormatExample3 {
	...
	public static void showOptions() {
		System.out.println("Introduce las siglas para el idioma al que quieres traducir el texto original");
		System.out.println("Paises disponibles :");
		System.out.println("de : Alemán");
		System.out.println("en : Ingles-Inglaterra");
		System.out.println("us : Ingles-EE.UU");
	...
	public static String getMessage1() {
		showOptions();
		System.out.println("1º siglas del idioma del pais : en minuscula");
		Scanner sc = null;
		try {
	...
	public static String getMessage2() {
		System.out.println("2º siglas del idioma del pais : en mayuscula");
		Scanner sc = null;
		try {
			sc = new Scanner(System.in);
			cadena2 = sc.nextLine();
...
//		Leer el fichero de propiedades
		Locale.setDefault(new Locale.Builder().setLanguage(cadena1.toLowerCase()).setRegion(cadena2.toUpperCase()).build());
//		Ruta donde esta el archivo con las traducciones y los acronimos que los identifica
		ResourceBundle bundle = ResourceBundle.getBundle(ruta,new Locale(cadena1.toLowerCase(), cadena2.toUpperCase()));
