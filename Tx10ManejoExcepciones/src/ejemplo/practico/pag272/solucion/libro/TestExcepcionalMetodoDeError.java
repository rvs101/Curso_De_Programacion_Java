 ...
 *
 */
public class TestExcepcionalMetodoDeError {
	 ...
	 * Función de clase
	 * 
	 * Recibe un objeto del tipo BusinessException y lanza una excepción ocultando
	 * las trazas de error
	 * 
	 * @param be - Objeto del tipo Business Exception
	 */
	private static void getError(BusinessException be) {
		switch (be.getErrorCode()) {
// Cada elemento 'enum' tiene un constructor con un mensaje definido	
		case EVEN:
